...
Write-Host "Step 1: Authenticating Docker with Google Cloud..."
gcloud auth configure-docker $GCP_REGION-docker.pkg.dev --quiet

Write-Host "Step 2: Tagging local image $LOCAL_IMAGE to $REMOTE_TAG..."
docker tag $LOCAL_IMAGE $REMOTE_TAG

Write-Host "Step 3: Pushing image to GCP..."
docker push $REMOTE_TAG

Write-Host "---------------------------------------------------"
Write-Host "Done! Your image is now in Artifact Registry."
